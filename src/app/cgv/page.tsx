...
export const metadata = { title: "Conditions générales de vente — Cap Réussite" };
    ...
    <>
      ...
      <main className="flex-1 py-16">
        <Container className="max-w-3xl">
          <h1 className="font-display text-3xl font-semibold text-ardoise-900">Conditions générales de vente</h1>

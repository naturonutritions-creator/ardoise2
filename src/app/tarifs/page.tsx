...
const PLANS = [
  {
    ...
    prix: "0 €",
    periode: " / 7 jours",
    description: "Accès complet à toutes les classes pendant 7 jours, sans carte bancaire.",
    avantages: [
      "Toutes les leçons, toutes les classes (CP à Terminale)",
